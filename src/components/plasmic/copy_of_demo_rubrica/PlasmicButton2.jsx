...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: TKFVjRPWqEO/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: ZeqKah4lLImWhI/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: XKSaS-SRgMn/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__gtCPe)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__apIv3)}
                role={"img"}
              />
            ),
