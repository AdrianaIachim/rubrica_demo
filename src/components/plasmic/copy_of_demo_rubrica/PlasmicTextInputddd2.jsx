...
import sty from "./PlasmicTextInputddd2.module.css"; // plasmic-import: pCo0VYC4l3p/css
import Searchsvg2Icon from "./icons/PlasmicIcon__Searchsvg2"; // plasmic-import: 12IA4DctBmjXgR/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: ZeqKah4lLImWhI/icon

export const PlasmicTextInputddd2__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "color"
...
export const PlasmicTextInputddd2__ArgProps = new Array(
  "placeholder",
  "endIcon",
  "startIcon",
  "value",
...
function PlasmicTextInputddd2__RenderFunc(props) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Searchsvg2Icon
                className={classNames(projectcss.all, sty.svg__qmElr)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__jG4Sl)}
                role={"img"}
              />
            ),
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicTextInputddd2__ArgProps,
          internalVariantPropNames: PlasmicTextInputddd2__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicTextInputddd2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicTextInputddd2";
  } else {
    func.displayName = `PlasmicTextInputddd2.${nodeName}`;
  }
  return func;
}

export const PlasmicTextInputddd2 = Object.assign(
  // Top-level PlasmicTextInputddd2 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicTextInputddd2
    internalVariantProps: PlasmicTextInputddd2__VariantProps,
    internalArgProps: PlasmicTextInputddd2__ArgProps,
    useBehavior
  }
);

export default PlasmicTextInputddd2;
/* prettier-ignore-end */
