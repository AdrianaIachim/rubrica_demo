...
import sty from "./PlasmicTextInputddd.module.css"; // plasmic-import: kWg9mjaIxWD/css
...
export const PlasmicTextInputddd__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "color"
...
export const PlasmicTextInputddd__ArgProps = new Array(
  "placeholder",
  "endIcon",
  "startIcon",
  "value",
...
function PlasmicTextInputddd__RenderFunc(props) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Searchsvg2Icon
                className={classNames(projectcss.all, sty.svg__h3Nh)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__bGvJ)}
                role={"img"}
              />
            ),
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicTextInputddd__ArgProps,
          internalVariantPropNames: PlasmicTextInputddd__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicTextInputddd__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicTextInputddd";
  } else {
    func.displayName = `PlasmicTextInputddd.${nodeName}`;
  }
  return func;
}

export const PlasmicTextInputddd = Object.assign(
  // Top-level PlasmicTextInputddd renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicTextInputddd
    internalVariantProps: PlasmicTextInputddd__VariantProps,
    internalArgProps: PlasmicTextInputddd__ArgProps,
    useBehavior
  }
);

export default PlasmicTextInputddd;
/* prettier-ignore-end */
